...
class ProductsTab(ttk.Frame):
    ...
    def _create_pending_ui(self):
        ...
        self.pending_tree = ttk.Treeview(
            tree_frame,
            columns=("ID", "SKU", "Name", "URL", "Platform", "Submitted By", "Status"),
            show="headings"
        )
        for col in ("ID", "SKU", "Name", "URL", "Platform", "Submitted By", "Status"):
    ...
    def load_products(self):
        ...
        # Save spreadsheet ID
        self.app.db.set_config("spreadsheet_id", spreadsheet_id)
